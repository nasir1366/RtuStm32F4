...
#define enc_rst_hi GPIOF->ODR|=GPIO_PIN_9
#define enc_rst_low GPIOF->ODR&=~GPIO_PIN_9

// set CS to 0 = active
#define enc_CSACTIVE GPIOA->ODR &= ~GPIO_PIN_15
// set CS to 1 = passive
#define enc_CSPASSIVE GPIOA->ODR |= GPIO_PIN_15
