...
#define relay1_on GPIOE->ODR |= GPIO_PIN_5
#define relay2_on GPIOE->ODR |= GPIO_PIN_6


#define relay1_off GPIOE->ODR &= ~GPIO_PIN_5
#define relay2_off GPIOE->ODR &= ~GPIO_PIN_6


#define door_sense (GPIOE->IDR & GPIO_PIN_12) 

#define ir_input_pin (GPIOG->IDR & GPIO_PIN_9)
#define rain_input_pin (GPIOE->IDR & GPIO_PIN_10)
...
//------------------keypad---------------------------------
#define up_key (GPIOD->IDR & GPIO_PIN_11)
#define down_key (GPIOD->IDR & GPIO_PIN_10)
#define right_key (GPIOE->IDR & GPIO_PIN_1)
#define left_key (GPIOE->IDR & GPIO_PIN_0)
#define ok_key (GPIOD->IDR & GPIO_PIN_1)
#define menu_key (GPIOD->IDR & GPIO_PIN_0)
#define esc_key (GPIOD->IDR & GPIO_PIN_4)
